    ...
    devServer: {
        ...
        proxy: {
            [process.env.VUE_APP_BASE_API]: {
                // target: `http://65.49.197.99/:3000`,  // 跨域代理  开发环境
                target: ` http://api.zhuishushenqi.com`,  // 生产环境  http://127.0.0.1:8888
                // target: `http://65.49.197.99/:3000/test/`,  // 开发环境http://api.zhuishushenqi.com/cats/lv2/statistics
                changeOrigin: true,
                pathRewrite: {
                    ['^' + process.env.VUE_APP_BASE_API]: ''
                }
